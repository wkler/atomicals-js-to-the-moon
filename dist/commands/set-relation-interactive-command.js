...
exports.SetRelationInteractiveCommand = void 0;
...
class SetRelationInteractiveCommand {
    constructor(electrumApi, options, atomicalId, relationName, values, owner, funding) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            (0, command_helpers_1.logBanner)(`Set Relation Interactive`);
...
exports.SetRelationInteractiveCommand = SetRelationInteractiveCommand;
