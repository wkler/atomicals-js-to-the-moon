...
exports.GetByTickerCommand = void 0;
...
class GetByTickerCommand {
    constructor(electrumApi, ticker, fetchType = command_interface_1.AtomicalsGetFetchType.GET, verbose) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            const responseResult = yield this.electrumApi.atomicalsGetByTicker(this.ticker);
...
exports.GetByTickerCommand = GetByTickerCommand;
