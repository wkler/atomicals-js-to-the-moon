...
exports.EmitInteractiveCommand = void 0;
...
class EmitInteractiveCommand {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            (0, command_helpers_1.logBanner)(`Emit Interactive`);
            // Attach any default data
            let filesData = yield (0, command_helpers_1.prepareFilesDataAsObject)(this.files);
            const { atomicalInfo, locationInfo, inputUtxoPartial } = yield (0, command_helpers_1.getAndCheckAtomicalInfo)(this.electrumApi, this.atomicalId, this.owner.address, 'NFT');
...
exports.EmitInteractiveCommand = EmitInteractiveCommand;
