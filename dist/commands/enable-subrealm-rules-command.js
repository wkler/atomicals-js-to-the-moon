...
exports.EnableSubrealmRulesCommand = void 0;
...
class EnableSubrealmRulesCommand {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            (0, command_helpers_1.logBanner)(`Enable Subrealm Rules Interactive`);
            // Attach any default data
            let filesData = yield (0, command_helpers_1.readJsonFileAsCompleteDataObjectEncodeAtomicalIds)(this.file, false);
...
exports.EnableSubrealmRulesCommand = EnableSubrealmRulesCommand;
