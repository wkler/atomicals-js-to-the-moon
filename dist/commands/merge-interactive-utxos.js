...
exports.MergeInteractiveUtxosCommand = void 0;
...
class MergeInteractiveUtxosCommand {
    constructor(electrumApi, options, currentOwnerAtomicalWIF, fundingWIF, validatedWalletInfo, satsbyte) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.buildAndSendTransaction(transferOptions, keypairAtomicalInfo, keypairFundingInfo, this.satsbyte);
        });
    }
    ...
    getUtxoBalanceSummary(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const utxo of res.utxos) {
                ...
                utxosFiltered.push(Object.assign({ txid: utxo.txid, index: utxo.index, value: utxo.value, height: utxo.height }, utxo));
            }
            return {
                utxos: utxosFiltered
            };
...
exports.MergeInteractiveUtxosCommand = MergeInteractiveUtxosCommand;
