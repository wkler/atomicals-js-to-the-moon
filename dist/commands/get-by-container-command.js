...
exports.GetByContainerCommand = void 0;
...
class GetByContainerCommand {
    constructor(electrumApi, container, fetchType = command_interface_1.AtomicalsGetFetchType.GET, verbose) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const responseResult = yield this.electrumApi.atomicalsGetByContainer(trimmedContainer);
...
exports.GetByContainerCommand = GetByContainerCommand;
